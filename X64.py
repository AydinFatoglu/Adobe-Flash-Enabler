...
def on_register_button_click():
    ...
    ocx_file = os.path.join(current_dir, 'Flash64_34_0_0_301.ocx')
...
root = tk.Tk()
root.title("Flash Player ActiveX x64 Enabler")
...
register_button = tk.Button(root, text="Enable Flash Player ActiveX (x64)", command=on_register_button_click)
register_button.pack(pady=5)

unregister_button = tk.Button(root, text="Disable Flash Player ActiveX (x64)", command=on_unregister_button_click)
